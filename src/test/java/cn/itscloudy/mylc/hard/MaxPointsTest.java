...
public class MaxPointsTest {
    ...
    enum Case {
        CASE1(new int[][]{{1, 2, 3}, {2, 5, 7}, {3, 5, 1}}, new int[]{5, 6, 2, 5, 6, 2}, new int[]{5, 8, 1, 5, 8, 1}),
        CASE2(new int[][]{{5, 2, 1}, {1, 1, 1}}, new int[]{3}, new int[]{0}),
        CASE3(new int[][]{
                ...
                new int[]{690474, 796832, 913701, 939418, 46696, 266869, 150594, 948153, 718874}, new int[]{
        ...
        Case(int[][] grid, int[] queries, int[] expectedResults) {
            this.grid = grid;
